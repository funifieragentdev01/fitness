angular.module('fitness').controller('SignupCtrl', function($scope, $location, $timeout, AuthService, ApiService, DataSyncService) {
    $scope.reg = {};
    $scope.loading = false;
    $scope.error = '';
    $scope.success = '';
    ...
    $scope.register = function() {
        ...
        if (!$scope.reg.password || $scope.reg.password.length < 6) { $scope.error = 'Senha deve ter no mínimo 8 caracteres.'; return; }
