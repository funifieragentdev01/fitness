angular.module('fitness').factory('PlanService', function($rootScope, $injector) {
    var service = {
        getPlan: function() {
            ...
            return { type: 'standard', changesUsed: { mealPlan: 0, workoutPlan: 0, goal: 0, bodyCheckin: 0, bioReport: 0, lastReset: new Date().toISOString().slice(0,10) } };
        },
        isPremium: function() {
